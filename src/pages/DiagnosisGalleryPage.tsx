            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
                        46種の狩猟鳥獣を水鳥・山鳥/里鳥・小型哺乳類・大型哺乳類の4カテゴリに整理しました。各カードをクリックすると、その動物をモチーフにした性格診断の結果サンプルに移動できます。画像は軽量なWebP形式で読み込み、モバイルでも快適に閲覧できます。興味のある動物から読み進めて、ぜひあなたのタイプも診断してみてください。
                    </p>
                </div>
