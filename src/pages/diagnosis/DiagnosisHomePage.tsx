            ...
            >
                ...
                <div className="container mx-auto text-center max-w-4xl relative z-10">
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-white/90 leading-relaxed max-w-3xl mx-auto">
                            この診断は、狩猟現場で求められる「観察力」「判断力」「持久力」などの資質を、日常の行動傾向からやさしく可視化するために設計されています。結果はMBTI風の解説とともに、代表的な狩猟鳥獣にたとえて分かりやすく提示します。ゲームの得意不得意に関係なく楽しめる内容のため、ハンター志望の方はもちろん、自然や動物が好きな方にもおすすめです。結果ページでは各動物の特徴や社会との関わりも学べます。
                        </p>
                    </div>
